...
import { getEnvironmentInfo } from '../config/auth';
...
const Login = () => {
  ...
  const { canChangeMode } = useAuthMode();
        ...
        <div className="login-container-professional">
          ...
          <div className="login-form-container">
            <div className="form-header">
              <h2 className="form-title">Sign in to BMed</h2>
            ...
            <div className="signin-container">
              {/* Show both options in development, Google-only in production */}
              {environmentInfo.environment === 'development' ? (
                <>
                  {/* Google OAuth Option */}
                  <button
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        await signInSimple(email, password);
                        navigate('/dashboard');
                      } catch (error) {
